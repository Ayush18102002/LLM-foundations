...
umasker = pipeline("fill-mask", model="bert-base-uncased")
result = umasker("The man works as a [MASK].")
print([r["token_str"] for r in result])

result = umasker("The woman works as a  [MASK].")
print([r["token_str"] for r in result])

"""
################ OUTPUT #####################
['lawyer', 'man', 'soldier', 'farmer', 'doctor']
